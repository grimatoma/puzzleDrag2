...
export const BUILDINGS = [
  { id: "hearth", icon: "bld_hearth", name: "Hearth", desc: "The heart of the village. Keeps folk warm and anchors the community.", cost: { coins: 0 }, lv: 1, x: 60, y: 360, w: 90, h: 110, look: { color: "#a8431a" } },
  { id: "mill", icon: "bld_mill", name: "Mill", desc: "Grinds and sorts harvest goods — reduces the flour needed to bake bread by 1.", cost: { plank: 8, hay_bundle: 6 }, lv: 1, x: 200, y: 380, w: 80, h: 90, look: { color: "#c8923a" },
    abilities: [{ id: "recipe_input_reduce", params: { recipe: "rec_bread", input: "flour", amount: 1 } }] },
  { id: "bakery", icon: "bld_bakery", name: "Bakery", desc: "Craft baked goods — bread, honey rolls, harvest pies — to sell for coins.", cost: { plank: 8, hay_bundle: 6, eggs: 4 }, lv: 1, x: 320, y: 360, w: 100, h: 110, look: { color: "#8a4a26" } },
  { id: "inn", icon: "bld_inn", name: "Inn", desc: "A warm roadside inn where travellers rest by the fire.", cost: { plank: 8, hay_bundle: 4, bread: 3 }, lv: 2, x: 470, y: 350, w: 110, h: 130, look: { color: "#4f6b3a" } },
  {
    id: "granary", icon: "bld_granary",
    name: "Granary",
  ...
  {
    id: "mining_camp", icon: "bld_mining_camp",
    name: "Mining Camp",
  ...
  { id: "larder", icon: "bld_larder", name: "Larder", desc: "Preserve and bottle your harvest — craft preserves, and add +1 turn to every mine ration.", cost: { bread: 12, plank: 4, soup: 6 }, lv: 2, x: 700, y: 395, w: 70, h: 85, look: { color: "#4f6b3a" } },
  { id: "forge", icon: "bld_forge", name: "Forge", desc: "Smith metal goods — hinges, lanterns, rings, and more — for high coin rewards.", cost: { plank: 6, iron_bar: 10, coke: 4 }, lv: 8, x: 800, y: 380, w: 100, h: 100, look: { color: "#5a6973" } },
  { id: "caravan_post", icon: "bld_caravan_post", name: "Caravan Post", desc: "Opens distant trade routes, letting you sell crafted goods to far-off markets.", cost: { plank: 20, block: 10, iron_bar: 5 }, lv: 8, x: 940, y: 390, w: 110, h: 90, look: { color: "#7e4f24" } },
  { id: "kitchen", icon: "bld_kitchen", name: "Kitchen", desc: "Converts surplus grain into supplies. Three supplies grant standard Mine entry.", cost: { bread: 9, dirt: 5, iron_bar: 6 }, lv: 2, x: 60, y: 260, w: 90, h: 100, look: { color: "#8a4a26" } },
  { id: "workshop", icon: "bld_workshop", name: "Workshop", desc: "Crafts tools from raw materials.", cost: { plank: 10, block: 6, iron_bar: 5 }, lv: 3, x: 180, y: 265, w: 90, h: 100, look: { color: "#6a5a3a" } },
  { id: "powder_store", icon: "bld_powder_store", name: "Powder Store", desc: "Stockpiles black powder. Produces 2 Bombs at the end of every season.", cost: { iron_bar: 12, coke: 6, block: 8 }, lv: 5, x: 310, y: 260, w: 90, h: 100, look: { color: "#3a2a1a" },
    abilities: [
      { id: "grant_tool", params: { tool: "bomb", amount: 2 }, trigger: "season_end" },
    ] },
  { id: "portal", icon: "bld_portal", name: "Magic Portal", desc: "A shimmering gateway. Summons unlock with Influence (Phase 8).", cost: { runes: 5 }, lv: 8, x: 440, y: 245, w: 100, h: 115, look: { color: "#4a2a7a" } },
  { id: "housing", icon: "bld_housing", name: "House",
  ...
  { id: "housing2", icon: "bld_housing2", name: "Housing Block",
  ...
  { id: "housing3", icon: "bld_housing3", name: "Housing Block",
    desc: "Lodging for the settlement's hired hands — houses +1 Villager each season (Villagers are spent to hire townsfolk).",
  ...
  { id: "silo", icon: "bld_silo", name: "Silo",
  ...
  { id: "barn", icon: "bld_barn", name: "Barn",
  ...
  { id: "harbor_dock", icon: "bld_harbor_dock", name: "Harbor Dock",
  ...
  { id: "fishmonger", icon: "bld_fishmonger", name: "Fishmonger",
  ...
  { id: "smokehouse", icon: "bld_smokehouse", name: "Smokehouse",
  ...
  { id: "clock_tower", icon: "bld_clock_tower", name: "Clock Tower",
  ...
  { id: "lighthouse", icon: "bld_lighthouse", name: "Lighthouse",
  ...
  { id: "apothecary", icon: "bld_apothecary", name: "Apothecary",
  ...
  { id: "sawmill", icon: "bld_sawmill", name: "Sawmill",
  ...
  { id: "watchtower", icon: "bld_watchtower", name: "Watchtower",
  ...
  { id: "stable", icon: "bld_stable", name: "Stable",
  ...
  { id: "apiary", icon: "bld_apiary", name: "Apiary",
  ...
  { id: "chapel", icon: "bld_chapel", name: "Chapel",
  ...
  { id: "brewery", icon: "bld_brewery", name: "Brewery",
  ...
  { id: "observatory", icon: "bld_observatory", name: "Observatory",
