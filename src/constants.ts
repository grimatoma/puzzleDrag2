...
export const BUILDINGS = [
  ...
  { id: "mill", name: "Mill", desc: "Grinds and sorts harvest goods — reduces the flour needed to bake bread by 1.", cost: { coins: 200, plank: 30 }, lv: 1, x: 200, y: 380, w: 80, h: 90, look: { color: "#c8923a" },
    abilities: [{ id: "recipe_input_reduce", params: { recipe: "rec_bread", input: "flour", amount: 1 } }] },
  { id: "bakery", name: "Bakery", desc: "Craft baked goods — bread, honey rolls, harvest pies — to sell for coins.", cost: { coins: 500, plank: 40, block: 10 }, lv: 1, x: 320, y: 360, w: 100, h: 110, look: { color: "#8a4a26" } },
  { id: "inn", name: "Inn", desc: "A warm roadside inn where travellers rest by the fire.", cost: { coins: 250, plank: 15 }, lv: 2, x: 470, y: 350, w: 110, h: 130, look: { color: "#4f6b3a" } },
  {
    id: "granary",
    name: "Granary",
  ...
  { id: "larder", name: "Larder", desc: "Preserve and bottle your harvest. Craft preserve jars and berry tinctures for coins.", cost: { coins: 250, plank: 15 }, lv: 2, x: 700, y: 395, w: 70, h: 85, look: { color: "#4f6b3a" } },
  { id: "forge", name: "Forge", desc: "Smith metal goods — hinges, lanterns, rings, and more — for high coin rewards.", cost: { coins: 1200, block: 60, iron_bar: 20 }, lv: 8, x: 800, y: 380, w: 100, h: 100, look: { color: "#5a6973" } },
  { id: "caravan_post", name: "Caravan Post", desc: "Opens distant trade routes, letting you sell crafted goods to far-off markets.", cost: { coins: 800, plank: 40 }, lv: 8, x: 940, y: 390, w: 110, h: 90, look: { color: "#7e4f24" } },
  { id: "kitchen", name: "Kitchen", desc: "Converts surplus grain into supplies. Three supplies grant standard Mine entry.", cost: { coins: 400, plank: 20 }, lv: 2, x: 60, y: 260, w: 90, h: 100, look: { color: "#8a4a26" } },
  { id: "workshop", name: "Workshop", desc: "Crafts tools from raw materials.", cost: { coins: 500, plank: 20, block: 10 }, lv: 3, x: 180, y: 265, w: 90, h: 100, look: { color: "#6a5a3a" } },
  { id: "powder_store", name: "Powder Store", desc: "Stockpiles black powder. Produces 2 Bombs at the end of every season.", cost: { coins: 600, block: 30, iron_bar: 5 }, lv: 5, x: 310, y: 260, w: 90, h: 100, look: { color: "#3a2a1a" },
    abilities: [
      { id: "grant_tool", params: { tool: "bomb", amount: 2 }, trigger: "season_end" },
    ] },
  { id: "portal", name: "Magic Portal", desc: "A shimmering gateway. Summons unlock with Influence (Phase 8).", cost: { coins: 2000, runes: 5 }, lv: 8, x: 440, y: 245, w: 100, h: 115, look: { color: "#4a2a7a" } },
