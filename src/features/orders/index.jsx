        ...
        {orders.map((o) => {
          ...
          return (
            <button
              ...
              className={`text-left rounded-xl border-2 px-3 py-3 flex flex-col gap-2 transition-transform hover:-translate-y-0.5 ${done ? "bg-[#cfe4a3] border-[#91bf24]" : "bg-[#f7ead8] border-[#c5a87a]"}`}
            >
              <div className="flex items-center gap-2.5">
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-bold text-[#a8431a] text-[13px] leading-tight truncate">{npc.name}</div>
