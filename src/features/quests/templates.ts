...
export const QUEST_TEMPLATES = [
  ...
  { id: "collect_sardine",  category: "collect", key: "tile_fish_sardine",  label: "Collect {n} sardines",
    targetMin: 12, targetMax: 30, coinBase: 35, coinPerUnit: 2 },
  { id: "collect_mackerel", category: "collect", key: "tile_fish_mackerel", label: "Collect {n} mackerel",
    targetMin: 8,  targetMax: 20, coinBase: 40, coinPerUnit: 3 },
  { id: "collect_clam",     category: "collect", key: "tile_fish_clam",     label: "Gather {n} clams",
    targetMin: 6,  targetMax: 14, coinBase: 40, coinPerUnit: 4 },
  { id: "collect_kelp",     category: "collect", key: "tile_fish_kelp",     label: "Cut {n} kelp",
  ...
  { id: "collect_stone",  category: "collect", key: "tile_mine_stone",  label: "Quarry {n} stone",
    targetMin: 12, targetMax: 30, coinBase: 35, coinPerUnit: 2 },
  { id: "collect_ore",    category: "collect", key: "tile_mine_iron_ore",    label: "Mine {n} ore",
    targetMin: 8,  targetMax: 20, coinBase: 45, coinPerUnit: 3 },
  { id: "collect_coal",   category: "collect", key: "tile_mine_coal",   label: "Haul {n} coal",
    targetMin: 8,  targetMax: 18, coinBase: 40, coinPerUnit: 3 },
  { id: "collect_gem",    category: "collect", key: "tile_mine_gem",    label: "Find {n} gems",
    targetMin: 4,  targetMax: 10, coinBase: 60, coinPerUnit: 6 },
  { id: "collect_dirt",   category: "collect", key: "tile_special_dirt",   label: "Shovel {n} dirt",
