...
export function reduce(state, action) {
  ...
  if (action.type === "APP/HIRE") {
    ...
    return {
      ...
      townsfolk: {
        ...state.townsfolk,
        hired: { ...state.townsfolk.hired, [id]: cur + 1 },
        pool: (state.townsfolk.pool ?? 1) - 1,
      },
