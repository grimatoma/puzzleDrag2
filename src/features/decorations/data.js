...
export const DECORATIONS = {
  ...
  stone_lantern: {
    id: "stone_lantern",
    name: "Stone Lantern",
    cost: { coins: 120, mine_stone: 6, plank: 2 },
    influence: 35,
  },
  apple_sapling: {
    id: "apple_sapling",
  ...
  driftwood_arch: {
    id: "driftwood_arch",
    name: "Driftwood Arch",
    cost: { coins: 180, plank: 4, fish_kelp: 6 },
    influence: 55,
  },
  pearl_fountain: {
    id: "pearl_fountain",
  ...
  fishing_dock: {
    id: "fishing_dock",
    name: "Fishing Dock",
    cost: { coins: 300, plank: 10, mine_stone: 4 },
    influence: 80,
  },
  ...
  cobble_well: {
    id: "cobble_well",
    name: "Cobble Well",
    cost: { coins: 220, mine_stone: 12, plank: 2 },
    influence: 65,
  },
  smelter_brazier: {
    id: "smelter_brazier",
    name: "Smelter Brazier",
    cost: { coins: 350, iron_bar: 2, mine_coal: 8 },
    influence: 90,
  },
};
