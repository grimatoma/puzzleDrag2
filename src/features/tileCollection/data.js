...
export const TILE_TYPES = [
  ...
  {
    id: "pheasant", category: "bird", displayName: "Pheasant",
    baseResource: "pheasant", tier: 1,
    discovery: { method: "default" },
    effects: {},
    description: "Can be collected with grass. Pleasant.",
  },
  {
    id: "chicken", category: "bird", displayName: "Chicken",
    baseResource: "chicken", tier: 1,
    discovery: { method: "default" },
    effects: {},
    description: "Great to produce eggs, slow for bonus herd animals. Not very courageous.",
  },
  {
    id: "hen", category: "bird", displayName: "Hen",
    baseResource: "hen", tier: 1,
    discovery: { method: "default" },
    effects: {},
    description: "Great for bonus herd animals, slow to produce eggs. Not always wet.",
  },
  {
    id: "rooster", category: "bird", displayName: "Rooster",
    baseResource: "rooster", tier: 1,
    discovery: { method: "default" },
    effects: {},
    description: "Four stars when collected. Avoided by wolves. Can spell cock-a-doodle-doo.",
  },
  {
    id: "wild_goose", category: "bird", displayName: "Wild Goose",
    baseResource: "wild_goose", tier: 1,
    discovery: { method: "default" },
    effects: {},
    description: "Attracts wolves. Prone to wanderlust.",
  },
  {
    id: "goose", category: "bird", displayName: "Goose",
    baseResource: "goose", tier: 2,
    discovery: { method: "research", researchOf: "chicken", researchAmount: 200 },
    effects: {},
    description: "A long chain gives vegetables. Its quill is said to be quite dangerous.",
  },
  {
    id: "parrot", category: "bird", displayName: "Parrot",
    baseResource: "parrot", tier: 1,
    discovery: { method: "default" },
    effects: {},
    description: "Three stars when collected. Can be collected with trees. Polly wants a cracker.",
  },
  {
    id: "phoenix", category: "bird", displayName: "Phoenix",
    baseResource: "phoenix", tier: 2,
    discovery: { method: "default" },
    effects: {},
    description: "Two stars when collected. Attracts wolves. Deadly to pests. Can light your fire.",
  },
  {
    id: "dodo", category: "bird", displayName: "Dodo",
    baseResource: "dodo", tier: 3,
    discovery: { method: "buy", coinCost: 250 },
    effects: {},
    description: "All are auto-collected when you make any chain. A proactive bird, always says \"do, do!\". Buy-only.",
  },
  {
    id: "pig_in_disguise", category: "bird", displayName: "Pig in Disguise",
    baseResource: "pig_in_disguise", tier: 3,
