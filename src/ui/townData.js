...
export const RESERVED_BUILDING_KEYS = new Set(["decorations", "_plots"]);
export const BUILDING_IDS = new Set(BUILDINGS.map((b) => b.id));
export const ALL_BUILDING_IDS = BUILDINGS.map((b) => b.id);
export const CRAFTING_STATIONS = new Set(["bakery", "forge", "larder"]);
