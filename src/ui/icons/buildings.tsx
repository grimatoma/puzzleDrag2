...
export function BldgSmithy({ size = 32, fill = "#3a3530" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true">
      ...
      <rect x="3" y="10" width="18" height="3" fill="#2b2218"/>
...
export function BldgScriptorium({ size = 32, fill = "#a8c4dc" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true">
      <path d="M3 22 L3 12 L21 12 L21 22 Z" fill="#2b2218"/>
      <path d="M3 12 L12 4 L21 12 Z" fill="#5a4030"/>
      <rect x="9" y="14" width="6" height="6" fill={fill}/>
      <line x1="10" y1="16" x2="14" y2="16" stroke="#2b2218" strokeWidth="0.5"/>
      <line x1="10" y1="17.5" x2="14" y2="17.5" stroke="#2b2218" strokeWidth="0.5"/>
      <line x1="10" y1="19" x2="13" y2="19" stroke="#2b2218" strokeWidth="0.5"/>
    </svg>
  );
}
...
export function BldgKitchen({ size = 32, fill = "#d0a070" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true">
      ...
      <rect x="3" y="14" width="18" height="2" fill="#2b2218"/>
      ...
      <circle cx="9" cy="18" r="1.5" fill="#2b2218"/>
      <circle cx="15" cy="18" r="1.5" fill="#2b2218"/>
    </svg>
  );
}
...
export function BldgDock({ size = 32, fill = "#5e8aa0" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true">
      ...
      <rect x="4" y="20" width="2" height="3" fill="#2b2218"/>
      <rect x="11" y="20" width="2" height="3" fill="#2b2218"/>
      <rect x="18" y="20" width="2" height="3" fill="#2b2218"/>
      <path d="M2 17 Q5 16 8 17 Q12 18 16 17 Q19 16 22 17" stroke={fill} strokeWidth="1.4" fill="none"/>
      <path d="M14 4 L14 18 M14 4 L20 10 L14 10" fill="#f8e7c6" stroke="#2b2218" strokeWidth="0.6"/>
    </svg>
  );
}
...
export function BldgInn({ size = 32, fill = "#a06040" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true">
      ...
      <rect x="10" y="16" width="4" height="6" fill="#2b2218"/>
...
export function BldgStable({ size = 32, fill = "#8a6a40" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path d="M9 22 L9 16 L11 16 L11 14 L13 14 L13 16 L15 16 L15 22 Z" fill="#2b2218"/>
      <path d="M3 14 L7 14 M3 16 L7 16 M3 18 L7 18 M17 14 L21 14 M17 16 L21 16 M17 18 L21 18"
        stroke="#2b2218" strokeWidth="0.5"/>
    </svg>
  );
}
