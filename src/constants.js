...
export const BUILDINGS = [
  ...
  { id: "workshop", name: "Workshop", desc: "Crafts shovels and other tools from raw materials.", cost: { coins: 600, plank: 30, stone: 10 }, lv: 3, x: 180, y: 265, w: 90, h: 100, color: "#6a5a3a" },
  ...
  { id: "housing", name: "Housing Block",
    ...
    x: 580, y: 260, w: 90, h: 100, color: "#a07a4a" },
