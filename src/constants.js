...
export const BIOMES = {
  farm: {
    ...
    resources: [
      { key: "grass_hay",          kind: "tile", label: "Hay",          color: 0xa8c769, dark: 0x4f6b3a, value: 1, next: "grain_wheat", glyph: "🌾", sway: { amp: 4.0, freq: 0.00060, gust: 0.20 } },
      { key: "grass_meadow", kind: "tile", label: "Meadow Grass", color: 0x7fb24a, dark: 0x3e5a18, value: 1, next: "grain_wheat", glyph: "🌿", sway: { amp: 4.5, freq: 0.00058, gust: 0.22 } },
      { key: "grass_spiky",  kind: "tile", label: "Spiky Grass",  color: 0x9bb55a, dark: 0x4a5e1c, value: 1, next: "grain_wheat", glyph: "🌱", sway: { amp: 2.5, freq: 0.00075, gust: 0.18 } },
      { key: "grain_wheat", kind: "tile", label: "Wheat", color: 0xdab947, dark: 0x7e5e1a, value: 2, next: "grain", glyph: "𓂃", sway: { amp: 5.0, freq: 0.00065, gust: 0.22 } },
      { key: "grain", kind: "resource", label: "Grain", color: 0xc8923a, dark: 0x5e3e10, value: 4, next: "grain_flour", glyph: "✿", sway: { amp: 1.2, freq: 0.00035, gust: 0.08 } },
      { key: "grain_flour", kind: "resource", label: "Flour", color: 0xf4e3c0, dark: 0x8a6a3a, value: 6, next: "bread", glyph: "◈", sway: { amp: 1.0, freq: 0.00030, gust: 0.05 } },
      { key: "wood_log",   kind: "resource", label: "Log",   color: 0x9b6b3e, dark: 0x5e3a1d, value: 2, next: "wood_plank", glyph: "🪵" },
      { key: "wood_plank", kind: "resource", label: "Plank", color: 0xc98c50, dark: 0x5e3a1d, value: 4, next: "wood_beam",  glyph: "▤" },
      ...
      { key: "veg_turnip",   kind: "tile", label: "Turnip",   color: 0xd87aa0, dark: 0x6e2a4a, value: 4, next: "soup", glyph: "🥬", sway: { amp: 1.6, freq: 0.00050, gust: 0.08 } },
      { key: "veg_beet",     kind: "tile", label: "Beet",     color: 0x6b1a3a, dark: 0x300818, value: 4, next: "soup", glyph: "🫜", sway: { amp: 1.5, freq: 0.00046, gust: 0.07 } },
      { key: "veg_cucumber", kind: "tile", label: "Cucumber", color: 0x4f8c3a, dark: 0x224018, value: 4, next: "soup", glyph: "🥒", sway: { amp: 2.4, freq: 0.00056, gust: 0.10 } },
      { key: "veg_squash",   kind: "tile", label: "Squash",   color: 0xe6c14a, dark: 0x7a5e10, value: 4, next: "soup", glyph: "🎃", sway: { amp: 1.7, freq: 0.00048, gust: 0.08 } },
      { key: "veg_mushroom", kind: "tile", label: "Mushroom", color: 0xc63a3a, dark: 0x601818, value: 4, next: "soup", glyph: "🍄", sway: { amp: 1.5, freq: 0.00044, gust: 0.06 } },
      { key: "veg_pepper",   kind: "tile", label: "Pepper",   color: 0xd83a3a, dark: 0x6e1818, value: 4, next: "soup", glyph: "🌶", sway: { amp: 2.2, freq: 0.00054, gust: 0.10 } },
      { key: "veg_broccoli", kind: "tile", label: "Broccoli", color: 0x4a8a3a, dark: 0x1e3e18, value: 4, next: "soup", glyph: "🥦", sway: { amp: 3.0, freq: 0.00060, gust: 0.12 } },
      { key: "soup",     kind: "resource", label: "Soup",     color: 0xc46a2f, dark: 0x6e3a18, value: 20, next: null, glyph: "🍲" },
      // Phase: wire-all-chains — terminal chain products from REFERENCE_CATALOG §4.
      { key: "pie",       kind: "resource", label: "Pie",       color: 0xb05428, dark: 0x582818, value: 90,  next: null, glyph: "🥧" },
      { key: "honey",     kind: "resource", label: "Honey",     color: 0xe8a020, dark: 0x745010, value: 300, next: null, glyph: "🍯" },
      { key: "meat",      kind: "resource", label: "Meat",      color: 0xc44848, dark: 0x682424, value: 21,  next: null, glyph: "🍖" },
      { key: "milk",      kind: "resource", label: "Milk",      color: 0xfaf6ec, dark: 0x807e74, value: 100, next: null, glyph: "🥛" },
      { key: "horseshoe", kind: "resource", label: "Horseshoe", color: 0x8a8a90, dark: 0x46464a, value: 400, next: null, glyph: "🧲" },
      { key: "eggs",      kind: "resource", label: "Eggs",      color: 0xf8efd0, dark: 0x807660, value: 5, next: null, glyph: "🥚" },
      { key: "bread",     kind: "resource", label: "Bread",     color: 0xc89048, dark: 0x6a4820, value: 4, next: null, glyph: "🍞" },
      ...
      // Grass
      { key: "grass_heather",      kind: "tile", label: "Heather",      color: 0x7a4f8a, dark: 0x3a2548, value: 1, next: null, glyph: "🌿", sway: { amp: 2.5, freq: 0.00060, gust: 0.10 } },
      // Grain
      { key: "grain_corn",         kind: "tile", label: "Corn",         color: 0xf4c84a, dark: 0x7a6020, value: 1, next: null, glyph: "🌽", sway: { amp: 4.0, freq: 0.00060, gust: 0.18 } },
      { key: "grain_buckwheat",    kind: "tile", label: "Buckwheat",    color: 0x9ab548, dark: 0x4a5820, value: 1, next: null, glyph: "🌾", sway: { amp: 3.5, freq: 0.00058, gust: 0.16 } },
      { key: "grain_manna",        kind: "tile", label: "Manna",        color: 0xf8e8c0, dark: 0x7a6e58, value: 1, next: null, glyph: "✨", sway: { amp: 1.5, freq: 0.00040, gust: 0.06 } },
      { key: "grain_rice",         kind: "tile", label: "Rice",         color: 0xc8d878, dark: 0x60683c, value: 1, next: null, glyph: "🌾", sway: { amp: 3.0, freq: 0.00056, gust: 0.14 } },
      // Fruits
      { key: "fruit_apple",        kind: "tile", label: "Apple",        color: 0xd4543a, dark: 0x6a2a18, value: 1, next: "pie", glyph: "🍎", sway: { amp: 1.2, freq: 0.00040, gust: 0.06 } },
      { key: "fruit_pear",         kind: "tile", label: "Pear",         color: 0xbcc436, dark: 0x5e6018, value: 1, next: "pie", glyph: "🍐", sway: { amp: 1.2, freq: 0.00040, gust: 0.06 } },
      { key: "fruit_golden_apple", kind: "tile", label: "Golden Apple", color: 0xf4c430, dark: 0x7a6010, value: 1, next: "pie", glyph: "🍏", sway: { amp: 1.2, freq: 0.00040, gust: 0.06 } },
      { key: "fruit_blackberry",   kind: "tile", label: "Blackberry",   color: 0x3a1a4a, dark: 0x180a20, value: 1, next: "pie", glyph: "🫐", sway: { amp: 1.0, freq: 0.00038, gust: 0.05 } },
      { key: "fruit_rambutan",     kind: "tile", label: "Rambutan",     color: 0xd8344a, dark: 0x6a1820, value: 1, next: "pie", glyph: "🌶", sway: { amp: 1.4, freq: 0.00042, gust: 0.07 } },
      { key: "fruit_starfruit",    kind: "tile", label: "Starfruit",    color: 0xe8c83c, dark: 0x726018, value: 1, next: "pie", glyph: "⭐", sway: { amp: 1.0, freq: 0.00040, gust: 0.05 } },
      { key: "fruit_coconut",      kind: "tile", label: "Coconut",      color: 0x5e3a14, dark: 0x2e1c08, value: 1, next: "pie", glyph: "🥥", sway: { amp: 0.8, freq: 0.00030, gust: 0.04 } },
      { key: "fruit_lemon",        kind: "tile", label: "Lemon",        color: 0xf4d030, dark: 0x7a6818, value: 1, next: "pie", glyph: "🍋", sway: { amp: 1.2, freq: 0.00042, gust: 0.06 } },
      { key: "fruit_jackfruit",    kind: "tile", label: "Jackfruit",    color: 0xa8a040, dark: 0x52501c, value: 1, next: "pie", glyph: "🍈", sway: { amp: 1.0, freq: 0.00038, gust: 0.05 } },
      // Flowers
      { key: "flower_pansy",       kind: "tile", label: "Pansy",        color: 0x7a3aa8, dark: 0x3c1c54, value: 1, next: "honey", glyph: "🌸", sway: { amp: 2.6, freq: 0.00070, gust: 0.14 } },
      { key: "flower_water_lily",  kind: "tile", label: "Water Lily",   color: 0xe890c0, dark: 0x70486a, value: 1, next: "honey", glyph: "🪷", sway: { amp: 0.8, freq: 0.00026, gust: 0.04 } },
      // Trees (distinct from existing log/plank/beam wood chain)
      { key: "tree_oak",           kind: "tile", label: "Oak",          color: 0x3a6818, dark: 0x1a3008, value: 1, next: "wood_log", glyph: "🌳", sway: { amp: 1.6, freq: 0.00030, gust: 0.10 } },
      { key: "tree_birch",         kind: "tile", label: "Birch",        color: 0xa8c038, dark: 0x546018, value: 1, next: "wood_log", glyph: "🌲", sway: { amp: 2.2, freq: 0.00034, gust: 0.12 } },
      { key: "tree_willow",        kind: "tile", label: "Willow",       color: 0x5a8a18, dark: 0x2a4008, value: 1, next: "wood_log", glyph: "🌿", sway: { amp: 3.0, freq: 0.00038, gust: 0.18 } },
      { key: "tree_fir",           kind: "tile", label: "Fir",          color: 0x2a5008, dark: 0x142404, value: 1, next: "wood_log", glyph: "🌲", sway: { amp: 0.6, freq: 0.00024, gust: 0.04 } },
      { key: "tree_cypress",       kind: "tile", label: "Cypress",      color: 0x1a3a08, dark: 0x0a1804, value: 1, next: "wood_log", glyph: "🌲", sway: { amp: 0.4, freq: 0.00020, gust: 0.02 } },
      { key: "tree_palm",          kind: "tile", label: "Palm Tree",    color: 0x5a8a18, dark: 0x2a4008, value: 1, next: "wood_log", glyph: "🌴", sway: { amp: 2.8, freq: 0.00040, gust: 0.16 } },
      // Birds (extends existing `bird` category)
      { key: "bird_pheasant",      kind: "tile", label: "Pheasant",     color: 0x8a4a18, dark: 0x44230a, value: 1, next: "eggs", glyph: "🦅", sway: { amp: 1.0, freq: 0.00040, gust: 0.05 } },
      { key: "bird_chicken",       kind: "tile", label: "Chicken",      color: 0xf0d8a0, dark: 0x786a48, value: 1, next: "eggs", glyph: "🐔", sway: { amp: 1.0, freq: 0.00040, gust: 0.05 } },
      { key: "bird_hen",           kind: "tile", label: "Hen",          color: 0xa86838, dark: 0x52321a, value: 1, next: "eggs", glyph: "🐓", sway: { amp: 1.0, freq: 0.00040, gust: 0.05 } },
      { key: "bird_rooster",       kind: "tile", label: "Rooster",      color: 0xd81818, dark: 0x6a0a0a, value: 1, next: "eggs", glyph: "🐓", sway: { amp: 1.2, freq: 0.00044, gust: 0.06 } },
      { key: "bird_wild_goose",    kind: "tile", label: "Wild Goose",   color: 0xa89878, dark: 0x524a3a, value: 1, next: "eggs", glyph: "🦢", sway: { amp: 1.2, freq: 0.00044, gust: 0.06 } },
      { key: "bird_goose",         kind: "tile", label: "Goose",        color: 0xfffce8, dark: 0x807e74, value: 1, next: "eggs", glyph: "🦆", sway: { amp: 1.2, freq: 0.00044, gust: 0.06 } },
      { key: "bird_parrot",        kind: "tile", label: "Parrot",       color: 0xd81818, dark: 0x6a0a0a, value: 1, next: "eggs", glyph: "🦜", sway: { amp: 1.4, freq: 0.00046, gust: 0.07 } },
      { key: "bird_phoenix",       kind: "tile", label: "Phoenix",      color: 0xf8a020, dark: 0x7c500e, value: 1, next: "eggs", glyph: "🔥", sway: { amp: 1.6, freq: 0.00050, gust: 0.10 } },
      { key: "bird_dodo",          kind: "tile", label: "Dodo",         color: 0xa89878, dark: 0x524a3a, value: 1, next: "eggs", glyph: "🦤", sway: { amp: 0.8, freq: 0.00036, gust: 0.04 } },
      { key: "bird_pig_in_disguise", kind: "tile", label: "Pig in Disguise", color: 0xe88a98, dark: 0x72424a, value: 1, next: "eggs", glyph: "🐽", sway: { amp: 0.8, freq: 0.00036, gust: 0.04 } },
      // Herd Animals
      { key: "herd_pig",           kind: "tile", label: "Pig",          color: 0xe88a98, dark: 0x72424a, value: 1, next: "meat", glyph: "🐖", sway: { amp: 0.6, freq: 0.00028, gust: 0.04 } },
      { key: "herd_hog",           kind: "tile", label: "Hog",          color: 0xa87838, dark: 0x523a1a, value: 1, next: "meat", glyph: "🐗", sway: { amp: 0.6, freq: 0.00028, gust: 0.04 } },
      { key: "herd_boar",          kind: "tile", label: "Boar",         color: 0x241408, dark: 0x100804, value: 1, next: "meat", glyph: "🐗", sway: { amp: 0.6, freq: 0.00028, gust: 0.04 } },
      { key: "herd_warthog",       kind: "tile", label: "Warthog",      color: 0x5a4828, dark: 0x2c2412, value: 1, next: "meat", glyph: "🐗", sway: { amp: 0.6, freq: 0.00028, gust: 0.04 } },
      { key: "herd_sheep",         kind: "tile", label: "Sheep",        color: 0xfffce8, dark: 0x807e74, value: 1, next: "meat", glyph: "🐑", sway: { amp: 0.6, freq: 0.00028, gust: 0.04 } },
      { key: "herd_alpaca",        kind: "tile", label: "Alpaca",       color: 0xf8e8c8, dark: 0x7c7264, value: 1, next: "meat", glyph: "🦙", sway: { amp: 0.6, freq: 0.00028, gust: 0.04 } },
      { key: "herd_goat",          kind: "tile", label: "Goat",         color: 0xd8c098, dark: 0x6c604a, value: 1, next: "meat", glyph: "🐐", sway: { amp: 0.6, freq: 0.00028, gust: 0.04 } },
      { key: "herd_ram",           kind: "tile", label: "Ram",          color: 0xa87838, dark: 0x523a1a, value: 1, next: "meat", glyph: "🐏", sway: { amp: 0.6, freq: 0.00028, gust: 0.04 } },
      // Cattle
      { key: "cattle_cow",         kind: "tile", label: "Cow",          color: 0xfffce8, dark: 0x807e74, value: 1, next: "milk", glyph: "🐄", sway: { amp: 0.4, freq: 0.00022, gust: 0.03 } },
      { key: "cattle_longhorn",    kind: "tile", label: "Longhorn",     color: 0xd89048, dark: 0x6a4820, value: 1, next: "milk", glyph: "🐂", sway: { amp: 0.4, freq: 0.00022, gust: 0.03 } },
      { key: "cattle_triceratops", kind: "tile", label: "Triceratops",  color: 0x5a8a28, dark: 0x2c4414, value: 1, next: "milk", glyph: "🦖", sway: { amp: 0.4, freq: 0.00022, gust: 0.03 } },
      // Mounts
      { key: "mount_horse",        kind: "tile", label: "Horse",        color: 0xa86838, dark: 0x52321a, value: 1, next: "horseshoe", glyph: "🐎", sway: { amp: 0.4, freq: 0.00022, gust: 0.03 } },
      { key: "mount_donkey",       kind: "tile", label: "Donkey",       color: 0x8a8478, dark: 0x44423a, value: 1, next: "horseshoe", glyph: "🫏", sway: { amp: 0.4, freq: 0.00022, gust: 0.03 } },
      { key: "mount_moose",        kind: "tile", label: "Moose",        color: 0x5a3814, dark: 0x2c1c0a, value: 1, next: "horseshoe", glyph: "🦌", sway: { amp: 0.4, freq: 0.00022, gust: 0.03 } },
      { key: "mount_mammoth",      kind: "tile", label: "Mammoth",      color: 0xa87838, dark: 0x523a1a, value: 1, next: "horseshoe", glyph: "🐘", sway: { amp: 0.4, freq: 0.00022, gust: 0.03 } },
    ],
    pool: FARM_TILE_POOL,
  },
  mine: {
    ...
    resources: [
      { key: "mine_stone",  kind: "tile", label: "Stone",  color: 0x9da3a8, dark: 0x3e4348, value: 1,  next: "mine_cobble", glyph: "◆" },
      { key: "mine_cobble", kind: "resource", label: "Cobble", color: 0xbbc1c6, dark: 0x4e5358, value: 3,  next: "mine_block",  glyph: "◇" },
      { key: "mine_block",  kind: "resource", label: "Block",  color: 0x7c8388, dark: 0x2a2e32, value: 6,  next: null,     glyph: "■" },
      { key: "mine_ore",    kind: "tile", label: "Ore",    color: 0xb6a3a3, dark: 0x5e4040, value: 3,  next: "mine_ingot",  glyph: "◊", sway: { amp: 0.4, freq: 0.00020, gust: 0.00 } },
      { key: "mine_ingot",  kind: "resource", label: "Ingot",  color: 0xe8e0d8, dark: 0x6a5a50, value: 6,  next: null,     glyph: "▭" },
      { key: "mine_coal",   kind: "tile", label: "Coal",   color: 0x333333, dark: 0x000000, value: 2,  next: "mine_coke",   glyph: "●" },
      { key: "mine_coke",   kind: "resource", label: "Coke",   color: 0x5a5a60, dark: 0x1a1a20, value: 4,  next: null,     glyph: "⬢" },
      { key: "mine_gem",    kind: "tile", label: "Gem",    color: 0x65e5ff, dark: 0x1686a3, value: 7,  next: "mine_cutgem", glyph: "◈", sway: { amp: 1.2, freq: 0.00028, gust: 0.04 } },
      { key: "mine_cutgem", kind: "resource", label: "CutGem", color: 0xa3f0ff, dark: 0x1686a3, value: 14, next: null,     glyph: "✦", sway: { amp: 1.2, freq: 0.00028, gust: 0.04 } },
      { key: "mine_gold",   kind: "tile", label: "Gold",   color: 0xffd34c, dark: 0x946b11, value: 5,  next: null,     glyph: "✺", sway: { amp: 1.0, freq: 0.00024, gust: 0.04 } },
      { key: "mine_dirt",   kind: "tile", label: "Dirt",   color: 0x7a6850, dark: 0x3e3a36, value: 1,  next: null,     glyph: "◫" },
    ],
    pool: MINE_TILE_POOL,
  },
  ...
  fish: {
    ...
    resources: [
      { key: "fish_sardine",  kind: "tile", label: "Sardine",  color: 0x9ab8c4, dark: 0x4a5e68, value: 1, next: "fish_raw",     glyph: "🐟", sway: { amp: 1.4, freq: 0.00050, gust: 0.08 } },
      { key: "fish_mackerel", kind: "tile", label: "Mackerel", color: 0x4a7a9a, dark: 0x223a4a, value: 2, next: "fish_raw",     glyph: "🐠", sway: { amp: 1.6, freq: 0.00052, gust: 0.10 } },
      { key: "fish_clam",     kind: "tile", label: "Clam",     color: 0xc8a888, dark: 0x705a40, value: 2, next: "fish_raw",     glyph: "🦪", sway: { amp: 0.4, freq: 0.00020, gust: 0.02 } },
      { key: "fish_oyster",   kind: "tile", label: "Oyster",   color: 0xd0c0a8, dark: 0x6a5e48, value: 3, next: "fish_raw",     glyph: "🦪", sway: { amp: 0.4, freq: 0.00020, gust: 0.02 } },
      { key: "fish_kelp",     kind: "tile", label: "Kelp",     color: 0x3a6a3a, dark: 0x1a3818, value: 1, next: "fish_oil",     glyph: "🌿", sway: { amp: 3.0, freq: 0.00060, gust: 0.18 } },
