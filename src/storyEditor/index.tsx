      ...
      <div style={{ flex: 1, display: "flex", minHeight: 0 }}>
        ...
        <div ref={canvasRef} data-canvas-bg="1" onMouseDown={onMouseDown} onWheel={onWheel}
          ...
          <div style={{ position: "absolute", bottom: 16, right: 16, zIndex: 10, display: "flex", gap: 4, background: "#fff", borderRadius: 8, border: `1.5px solid ${C.border}`, padding: 4 }}>
            <button onClick={() => setZoom((z) => Math.min(2, z + 0.1))} title="Zoom in" aria-label="Zoom in" style={{ width: 28, height: 28, borderRadius: 5, border: `1px solid ${C.border}`, background: C.parchment, color: C.ink, font: "700 16px/1 system-ui", cursor: "pointer" }}>+</button>
            ...
            <button onClick={() => setZoom((z) => Math.max(0.3, z - 0.1))} title="Zoom out" aria-label="Zoom out" style={{ width: 28, height: 28, borderRadius: 5, border: `1px solid ${C.border}`, background: C.parchment, color: C.ink, font: "700 16px/1 system-ui", cursor: "pointer" }}>−</button>
