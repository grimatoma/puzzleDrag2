...
describe("10.1 — RECIPES.tools table", () => {
  ...
  it("axe costs 1 stone", () => {
    expect(RECIPES.tools.axe.inputs.stone).toBe(1);
  });

  it("fertilizer costs 1 hay + 1 dirt", () => {
    expect(RECIPES.tools.fertilizer.inputs.hay).toBe(1);
