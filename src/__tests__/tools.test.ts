...
describe("1.2 — hasValidChain", () => {
  ...
  it("checkerboard (4 types) has no valid chain", async () => {
    ...
    const ROWS = 6, COLS = 6;
    const types = ["tile_grass_grass", "tile_tree_oak", "berry", "eggs"];
    const grid = [];
  ...
  it("3-cluster of same resource passes", async () => {
    ...
    grid[0][0] = { res: { key: "tile_grass_grass" } };
    grid[0][1] = { res: { key: "tile_grass_grass" } };
    grid[0][2] = { res: { key: "tile_grass_grass" } };
