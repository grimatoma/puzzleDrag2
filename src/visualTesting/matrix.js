...
const tileRoutes = [
  ...
  ["tiles-farm-grain", "#/tiles/farm/grain"],
  ["tiles-farm-bird", "#/tiles/farm/bird"],
  ["tiles-farm-vegetables", "#/tiles/farm/vegetables"],
  ["tiles-farm-fruits", "#/tiles/farm/fruits"],
  ["tiles-farm-flowers", "#/tiles/farm/flowers"],
  ["tiles-farm-trees", "#/tiles/farm/trees"],
  ["tiles-farm-herd", "#/tiles/farm/herd_animals"],
  ["tiles-farm-cattle", "#/tiles/farm/cattle"],
  ["tiles-farm-mounts", "#/tiles/farm/mounts"],
  ["tiles-mining-stone", "#/tiles/mining/mine_stone"],
  ["tiles-mining-ore", "#/tiles/mining/mine_ore"],
  ["tiles-mining-coal", "#/tiles/mining/mine_coal"],
  ["tiles-mining-gem", "#/tiles/mining/mine_gem"],
  ["tiles-mining-gold", "#/tiles/mining/mine_gold"],
  ["tiles-mining-dirt", "#/tiles/mining/mine_dirt"],
...
export const VISUAL_SCENARIOS = [
  ...
  { id: "shell-menu-about", state: "fresh", hash: "#/town", actions: [click("Menu"), clickText("About")], diff: domDiff },
  ...
  { id: "town-purchase-confirm", state: "buildReady", hash: "#/town", actions: [click("Build"), clickText("Mill"), clickLast("Build"), clickText("Place here")], diff: domDiff },
  ...
  { id: "start-farming-fertilizer", state: "fertilizerEntry", hash: "#/town", actions: [click("Enter Farm Field"), { type: "checkLabel", text: "Use Fertilizer" }], diff: domDiff },
  { id: "start-farming-dangers", state: "farmDangersEntry", hash: "#/town", actions: [click("Enter Farm Field")], diff: domDiff },
  ...
  { id: "entry-mine-provision-packed", state: "mineTownFood", hash: "#/town", actions: [click("Enter Mine"), clickText("Pack all")], diff: domDiff },
  { id: "entry-fish-provision-packed", state: "harborTownFood", hash: "#/town", actions: [click("Enter Harbor"), clickText("Pack all")], diff: domDiff },
  ...
  { id: "board-farm-chain-12", state: "boardFarmLong", hash: "#/board", actions: [api("holdChain", { key: "grass_hay", length: 12 })], diff: canvasDiff },
  { id: "board-farm-invalid-min-chain", state: "boardFarmBoss", hash: "#/board", actions: [api("holdChain", { key: "grass_hay", length: 3 })], diff: canvasDiff },
  ...
  { id: "inventory-list-mode", state: "rich", hash: "#/inventory", actions: [click("Switch to list view")], skipProjects: ["iphone-landscape", "iphone-portrait"], diff: domDiff },
  { id: "inventory-filter-sellable", state: "rich", hash: "#/inventory", actions: [clickText("Sellable only")], diff: domDiff },
  ...
  { id: "inventory-sort-recent", state: "rich", hash: "#/inventory", actions: [clickText("Recent")], diff: domDiff },
  { id: "orders-mixed", state: "rich", hash: "#/orders", diff: domDiff },
  { id: "orders-after-delivery", state: "rich", hash: "#/orders", actions: [api("dispatch", { type: "TURN_IN_ORDER", id: "order-ready" })], diff: domDiff },
  ...
  { id: "crafting-larder", state: "rich", hash: "#/crafting/larder", diff: domDiff },
  { id: "crafting-forge", state: "rich", hash: "#/crafting/forge", diff: domDiff },
  { id: "crafting-workshop", state: "rich", hash: "#/crafting/workshop", diff: domDiff },
  { id: "crafting-decor", state: "rich", hash: "#/crafting/decor", diff: domDiff },
  { id: "crafting-queue", state: "craftQueue", hash: "#/crafting/bakery", diff: domDiff },
  { id: "portal-locked", state: "fresh", hash: "#/portal", diff: domDiff },
  { id: "portal-rich", state: "rich", hash: "#/portal", diff: domDiff },
  { id: "portal-insufficient", state: "portalInsufficient", hash: "#/portal", diff: domDiff },
  ...
  { id: "map-level-locked", state: "mapLevelLocked", hash: "#/cartography/orchard", diff: canvasDiff },
  { id: "map-unreachable", state: "mapUnreachable", hash: "#/cartography/quarry", diff: canvasDiff },
  ...
  { id: "map-capital-ready", state: "mapCapitalReady", hash: "#/cartography/oldcapital", diff: canvasDiff },
  ...
  { id: "charter-all-choices", state: "charter", view: "charter", actions: [clickText("All choices")], diff: domDiff },
  ...
  { id: "townsfolk-orders", state: "rich", hash: "#/townsfolk/orders", diff: domDiff },
  ...
  { id: "boons-mine", state: "boons", view: "boons", actions: [clickText("Mine")], diff: domDiff },
  { id: "boons-harbor", state: "boons", view: "boons", actions: [clickText("Harbor")], diff: domDiff },
...
export const VISUAL_MOBILE_SMOKE_SCENARIO_IDS = [
  "shell-town-fresh",
  "shell-menu-main",
  "town-home-built-out",
