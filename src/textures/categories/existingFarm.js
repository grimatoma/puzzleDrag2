...
export const ICONS = {
  ...
  grain_flour:         { label:"Flour",        color:"#f0e2b8", draw:drawFlour },
  wood_log:           { label:"Log",          color:"#9c6a3c", draw:drawLog },
  wood_plank:         { label:"Plank",        color:"#caa168", draw:drawPlank },
  wood_beam:          { label:"Beam",         color:"#7a5028", draw:drawBeam },
  berry:         { label:"Berry",        color:"#c43a68", draw:drawBerry },
  berry_jam:           { label:"Jam",          color:"#a72c5e", draw:drawJam },
  bird_egg:           { label:"Egg",          color:"#f8e8c0", draw:drawEgg },
