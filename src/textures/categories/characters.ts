...
function drawHead(ctx: CanvasRenderingContext2D, opts: HeadOpts = {}) {
...
function drawMira(ctx: CanvasRenderingContext2D) {
...
function drawTomas(ctx: CanvasRenderingContext2D) {
...
function drawBram(ctx: CanvasRenderingContext2D) {
...
function drawLiss(ctx: CanvasRenderingContext2D) {
...
function drawWren(ctx: CanvasRenderingContext2D) {
...
function drawFrostmaw(ctx: CanvasRenderingContext2D) {
...
function drawQuagmire(ctx: CanvasRenderingContext2D) {
...
function drawEmberDrake(ctx: CanvasRenderingContext2D) {
...
function drawOldStoneface(ctx: CanvasRenderingContext2D) {
...
function drawMossback(ctx: CanvasRenderingContext2D) {
...
function drawWorkerFarmer(ctx: CanvasRenderingContext2D) {
...
function drawWorkerLumberjack(ctx: CanvasRenderingContext2D) {
...
function drawWorkerMiner(ctx: CanvasRenderingContext2D) {
...
function drawWorkerBaker(ctx: CanvasRenderingContext2D) {
