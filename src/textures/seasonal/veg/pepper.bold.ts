// BOLD seasonal art variant for the BELL PEPPER vegetable tile.
//
// A side-by-side decision prototype against `pepper.ts`. SAME glossy bell pepper
// every season (identity-safe), but the seasons swing HARD on colour + a real
// seasonal prop (blossom / fallen leaf / snow cap + base snow), and the idle is
...
//
// Architecture mirrors pepper.ts: a single parameterized `paint(ctx, p, pose)`
