// Production seasonal art for the PANSY flower board tile — the approved bold
// direction. Same five-petal violet pansy FACE in every season (identity rule
// §36: same silhouette all four seasons — never a bare stub, never morphing into
// something else), with seasonal treatment dialled UP so each season reads:
//
