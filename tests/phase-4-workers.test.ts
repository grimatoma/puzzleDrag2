...
function withCoins(coins) {
  return {
    ...createInitialState(),
    coins,
    inventory: { home: { tile_grass_hay: 100,
      tile_tree_oak: 100,
      tile_mine_stone: 100,
      flour: 100,
      eggs: 100, } },
