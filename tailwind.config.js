  ...
  theme: {
    extend: {
      colors: {
        ...
        slate:            "var(--slate)",
        danger:           "var(--danger)",
        "biome-farm":     "var(--biome-farm)",
        "biome-mine":     "var(--biome-mine)",
        "biome-fish":     "var(--biome-fish)",
        "hud-bg":         "var(--hud-bg)",
        "board-tools":    "var(--board-tools-top)",
        "board-panel":    "var(--board-panel-border)",
        "board-chip":     "var(--board-chip-bg)",
