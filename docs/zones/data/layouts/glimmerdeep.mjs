...
const LM = [640, 470];
const tunnel = (a, b, t) => ({ kind: "span", pts: [a, b], w: 9, col: "#4a4060", tier: t });
const crystal = (cx, cy) => ({ kind: "disc", cx, cy, r: 16, ry: 12, col: "#2aa8c4", glow: "#5af0ff" });
...
export default {
  ...
  roads: [],
  features: [
    crystal(640, 360), crystal(300, 380), crystal(440, 800), crystal(960, 560), crystal(1000, 280),
