...
Reads the rendered assets under reference/docs/canvas-tile-review/ (gifs/, category/,
contact-sheet.png, metrics.json) and the condensed per-icon critique + global
synthesis embedded below, and writes reference/docs/canvas-tile-review/index.html.
...
so keep index.html inside reference/docs/canvas-tile-review/.
"""
...
<div class="wrap">
  ...
  <footer>
    ...
    continuously. Keep this file in <code>reference/docs/canvas-tile-review/</code> so the image paths resolve.
  </footer>
</div>
</body></html>"""
